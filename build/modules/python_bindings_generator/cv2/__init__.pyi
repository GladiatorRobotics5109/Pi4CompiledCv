...
def createTrackbar(trackbarName: str, windowName: str, value: int, count: int, onChange: typing.Callable[[int], None]) -> None: ...

def createButton(buttonName: str, onChange: typing.Callable[[tuple[int] | tuple[int, typing.Any]], None], userData: typing.Any | None = ..., buttonType: int = ..., initialButtonState: int = ...) -> None: ...

def setMouseCallback(windowName: str, onMouse: typing.Callable[[int, int, int, int, typing.Any | None], None], param: typing.Any | None = ...) -> None: ...
...
def dnn_registerLayer(layerTypeName: str, layerClass: typing.Type[cv2.dnn.LayerProtocol]) -> None: ...

def dnn_unregisterLayer(layerTypeName: str) -> None: ...

def redirectError(onError: typing.Callable[[int, str, str, str, int], None] | None) -> None: ...
